...
const ShippingModule = () => {
  ...
  // Pestaña "Envíos programados": vive en ShippingScheduler (estructura de
  // la hoja de embarques: semana → día → export → órdenes).
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] p-4 md:p-8 space-y-8 font-barlow animate-in fade-in duration-700">
      ...
      {activeTab === 'programados' && <ShippingScheduler />}
