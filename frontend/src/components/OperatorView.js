...
const TicketCard = ({ ticket, onSelect, isActive, onComments }) => {
  ...
  return (
    <div
      ...
      className={`w-full text-left p-4 rounded-lg border transition-all cursor-pointer ${isActive ? 'border-primary bg-primary/10 ring-1 ring-primary' : 'border-border bg-card hover:border-primary/50'}`}
